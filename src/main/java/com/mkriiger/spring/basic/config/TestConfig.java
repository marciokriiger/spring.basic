package com.mkriiger.spring.basic.config;
...
import com.mkriiger.spring.basic.entities.Payment;
...
import com.mkriiger.spring.basic.repositories.OrderItemRepository;
import com.mkriiger.spring.basic.repositories.OrderRepository;
import com.mkriiger.spring.basic.repositories.ProductRepository;
import com.mkriiger.spring.basic.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), 
				OrderStatus.WAITING_PAYMENT, u1);
